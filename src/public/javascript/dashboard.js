  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const mockData = {
        ...
        totalSuccess: 142,
        history: [
          { invoice: 'INV-001', name: 'Alif Ramadhan', date: '2026-06-23', status: 'Success', total: 150000 },
          { invoice: 'INV-002', name: 'Siti Nurhaliza', date: '2026-06-22', status: 'Success', total: 300000 },
          { invoice: 'INV-003', name: 'Budi Santoso', date: '2026-06-21', status: 'Success', total: 150000 },
          { invoice: 'INV-004', name: 'Anya Geraldine', date: '2026-06-20', status: 'Success', total: 450000 }
        ]
      };
